@extends('layouts.app')
@section('content')
    <section class="bg-white py-10 w-100 h-100">
        <div class="container container-fluid px-5">
            <div class="row gx-6 text-center">
                <div class="col-lg-12 mb-5 mb-lg-0 ">
                    ...
                    <p class="mb-0">Our customizable, block-based build system makes creating your next project fast and
                        easy!</p> --}}
                    </div>
            ...
            <div class="row gx-5">
                <div class="col-lg-6 mb-5 mb-lg-0 divider-right" data-aos="fade">
                    <div class="testimonial p-lg-5">
                        ...
                        <p class="testimonial-quote text-primary">"Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                            Ut error vel omnis adipisci. Ad nam officiis sapiente dicta incidunt harum."</p>
                ...
                <div class="col-lg-6" data-aos="fade" data-aos-delay="100">
                    <div class="testimonial p-lg-5">
                        ...
                        <p class="testimonial-quote text-primary">"Adipisci mollitia nemo magnam iure, temporibus molestiae
                            odit, sit harum dolores neque maiores quo eligendi nam corrupti."</p>
        ...
        <div class="container px-5">
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-4 col-md-6 mb-5" data-aos="fade-up" data-aos-delay="100">
                    <a class="card text-center text-decoration-none h-100 lift" href="#!">
                        <div class="card-body py-5">
                            <div class="icon-stack icon-stack-lg bg-red-soft text-red mb-4"><i data-feather="tool"></i>
                            </div>
                            <h5>Utilities</h5>
                ...
                <div class="col-lg-4 col-md-6 mb-5 mb-lg-0" data-aos="fade-up">
                    <a class="card text-center text-decoration-none h-100 lift" href="#!">
                        <div class="card-body py-5">
                            ...
                            <h5>Documentation</h5>
                            <p class="card-text small">Our code is fully documented with instructions and usage examples.
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                    <a class="card text-center text-decoration-none h-100 lift" href="#!">
                        <div class="card-body py-5">
                            <div class="icon-stack icon-stack-lg bg-blue-soft text-blue mb-4"><i data-feather="code"></i>
                            </div>
                            <h5>Code Snippets</h5>
                            <p class="card-text small">Use code snippets to easily drop new components into your project.
                            </p>
                        </div>
                    </a>
                </div>
